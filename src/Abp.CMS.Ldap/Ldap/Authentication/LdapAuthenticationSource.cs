...
namespace Abp.CMS.Ldap.Authentication
{
    /// <summary>
        ...
        where TUser : AbpUser<TTenant, TUser>, new()
    {
        ...
        private readonly IAbpCMSLdapModuleConfig _ldapModuleConfig;

        protected LdapAuthenticationSource(ILdapSettings settings, IAbpCMSLdapModuleConfig ldapModuleConfig)
        {
            _settings = settings;
