...
namespace Abp.Authorization.Users
{
        ...
        where TUser : AbpUser<TTenant, TUser>
    {
        ...
        private async Task<bool> IsEmailConfirmationRequiredForLoginAsync(int? tenantId)
        {
            ...
            {
                return await SettingManager.GetSettingValueForTenantAsync<bool>(AbpCMSSettingNames.UserManagement.IsEmailConfirmationRequiredForLogin, tenantId.Value);
            }

            return await SettingManager.GetSettingValueForApplicationAsync<bool>(AbpCMSSettingNames.UserManagement.IsEmailConfirmationRequiredForLogin);
        }
