...
namespace Abp.CMS.SampleApp.Tests.Users
{
    public class UserLogin_Tests : SampleAppTestBase
    {
        ...
        public async Task Should_Not_Login_If_Email_Confirmation_Is_Enabled_And_User_Has_Not_Confirmed()
        {
            ...
            await Resolve<ISettingManager>().ChangeSettingForTenantAsync(AbpSession.GetTenantId(), AbpCMSSettingNames.UserManagement.IsEmailConfirmationRequiredForLogin, "true");
