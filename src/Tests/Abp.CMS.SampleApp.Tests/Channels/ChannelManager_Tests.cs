...
namespace Abp.CMS.SampleApp.Tests.Channel
{
    public class ChannelManager_Tests : SampleAppTestBase
    {
        ...
        {
            //Act
            await _ChannelManager.CreateAsync(new Channels.Channel(AbpSession.TenantId, "Root 1"));
        ...
        public async Task Should_Create_Child_OU()
        {
            ...
            //Act
            await _ChannelManager.CreateAsync(new Channels.Channel(AbpSession.TenantId, "OU11 New Child", ou11.Id));
        ...
        public async Task Should_Not_Create_OU_With_Same_Name_In_Same_Level()
        {
            ...
            await Assert.ThrowsAsync<UserFriendlyException>(
                () => _ChannelManager.CreateAsync(
                    new Channels.Channel(AbpSession.TenantId, "OU112", ou11.Id)
                    )
                );
        }
        ...
        private Channels.Channel GetOU(string diplayName)
        {
        ...
        private Channels.Channel GetOUOrNull(string diplayName)
        {
